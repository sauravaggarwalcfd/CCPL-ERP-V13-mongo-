...
async def get_category(code: str):
    ...
    return {
        ...
        "purchase_uom": getattr(category, 'purchase_uom', 'PCS'),
        "storage_uom": getattr(category, 'storage_uom', 'PCS'),
        "icon": category.icon,
    ...
    return [
        {
            ...
            "purchase_uom": getattr(i, 'purchase_uom', 'PCS'),
            "storage_uom": getattr(i, 'storage_uom', 'PCS'),
            "icon": i.icon,
