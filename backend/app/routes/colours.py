...
def colour_to_response(colour: ColourMaster) -> ColourResponse:
    ...
    return ColourResponse(
        ...
        colour_group=colour.colour_group.value,
...
async def get_colour_groups():
    ...
    return [
        {
            "code": group.value,
            "name": COLOUR_GROUP_NAMES[group],
            "value": group.value,
            "label": COLOUR_GROUP_NAMES[group]
        }
        for group in ColourGroup
    ]
...
async def create_colour(data: ColourCreate):
    ...
    group_name = COLOUR_GROUP_NAMES.get(data.colour_group, data.colour_group.value)
...
async def update_colour(code: str, data: ColourUpdate):
    ...
    if "colour_group" in update_data:
        update_data["group_name"] = COLOUR_GROUP_NAMES.get(
            update_data["colour_group"],
            update_data["colour_group"].value
        )
