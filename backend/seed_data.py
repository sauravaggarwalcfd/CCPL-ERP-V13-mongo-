    ...
    try:
        ...
        brands = [
            ...
            },
            {
                ...
                "phone": "+91-9876543212",
                "website": "https://www.classiccottons.com",
                "is_active": True,
                "created_at": datetime.utcnow(),
                "updated_at": datetime.utcnow()
            },
            {
                ...
                "website": "https://www.trendytrims.cn",
                "is_active": True,
                "created_at": datetime.utcnow(),
                "updated_at": datetime.utcnow()
            },
            {
                ...
                "phone": "+91-9876543213",
                "website": "https://www.ecofabrics.in",
                "is_active": True,
                "created_at": datetime.utcnow(),
                "updated_at": datetime.utcnow()
            },
            {
                "brand_code": "BR-006",
                "brand_name": "Premium Buttons",
                "brand_category": "Button",
                "country": "India",
                "contact_person": "Suresh Mehta",
                "email": "suresh@premiumbuttons.com",
                "phone": "+91-9876543214",
                "website": "https://www.premiumbuttons.com",
                "is_active": True,
                "created_at": datetime.utcnow(),
                "updated_at": datetime.utcnow()
            },
            {
                "brand_code": "BR-007",
                "brand_name": "Fashion Accessories",
                "brand_category": "Accessory",
                "country": "India",
                "contact_person": "Kavita Joshi",
                "email": "kavita@fashionaccessories.com",
                "phone": "+91-9876543215",
                "website": "https://www.fashionaccessories.com",
                "is_active": True,
                "created_at": datetime.utcnow(),
                "updated_at": datetime.utcnow()
            }
