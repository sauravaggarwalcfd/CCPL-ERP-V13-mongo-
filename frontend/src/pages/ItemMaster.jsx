                      ...
                      >
                        <td className="px-6 py-4">
                          {item.thumbnail_url || item.image_url ? (
                            <img
                              src={files.getThumbnailUrl(item.thumbnail_url) || files.getFileUrl(item.image_url)}
                              alt={item.item_name}
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 mt-1">
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${selectedItem.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
